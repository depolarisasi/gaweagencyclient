...
<div class="min-h-screen bg-base-300">
    <div class="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
        ...
        <div class="hidden lg:flex items-center justify-center bg-success text-success-content p-12">
            <div class="max-w-xl">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-2xl font-bold">Bergabung dengan Gawe Agency</span>
                </div>
                <h2 class="text-4xl font-extrabold leading-tight mb-4">Mulai perjalanan kreatifmu bersama kami</h2>
                <p class="opacity-90 mb-6">Buat akun untuk mengelola proyek, kolaborasi dengan tim, dan memamerkan karya terbaikmu.</p>
                <div class="flex -space-x-2 mb-3">
                    <img class="w-8 h-8 rounded-full ring-2 ring-success" src="https://i.pravatar.cc/40?img=5" alt="avatar" />
                    <img class="w-8 h-8 rounded-full ring-2 ring-success" src="https://i.pravatar.cc/40?img=6" alt="avatar" />
                    <img class="w-8 h-8 rounded-full ring-2 ring-success" src="https://i.pravatar.cc/40?img=7" alt="avatar" />
                    <img class="w-8 h-8 rounded-full ring-2 ring-success" src="https://i.pravatar.cc/40?img=8" alt="avatar" />
                </div>
                <div class="text-sm opacity-90">Bergabung dengan komunitas <span class="font-semibold">15k+</span> kreator</div>
            </div>
        </div>
