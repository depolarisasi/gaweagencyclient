                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="billing_cycle" class="select select-bordered w-full @error('billing_cycle') select-error @enderror">
                            ...
                            <option value="quarterly" {{ old('billing_cycle', $subscriptionPlan->billing_cycle) === 'quarterly' ? 'selected' : '' }}>Triwulan (3 Bulan)</option>
                            <option value="semi_annual" {{ old('billing_cycle', $subscriptionPlan->billing_cycle) === 'semi_annual' ? 'selected' : '' }}>Semi Annual (6 Bulan)</option>
                            <option value="annual" {{ old('billing_cycle', $subscriptionPlan->billing_cycle) === 'annual' ? 'selected' : '' }}>Tahunan</option>
                        </select>
                        @error('billing_cycle')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
