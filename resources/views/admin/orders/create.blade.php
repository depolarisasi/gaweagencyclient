                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <select name="billing_cycle" class="select select-bordered focus:select-primary @error('billing_cycle') select-error @enderror">
                                ...
                                <option value="6_months" {{ old('billing_cycle') === '6_months' ? 'selected' : '' }}>Semi-Annually (6 months)</option>
                                <option value="annually" {{ old('billing_cycle') === 'annually' ? 'selected' : '' }}>Annually (12 months)</option>
                                <option value="2_years" {{ old('billing_cycle') === '2_years' ? 'selected' : '' }}>2 Years (24 months)</option>
                                <option value="3_years" {{ old('billing_cycle') === '3_years' ? 'selected' : '' }}>3 Years (36 months)</option>
                            </select>
                            @error('billing_cycle')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
