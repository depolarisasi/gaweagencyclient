                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <select name="order_type" class="select select-bordered focus:select-primary @error('order_type') select-error @enderror" required>
                                ...
                                <option value="product" {{ old('order_type') === 'product' ? 'selected' : '' }}>🛍️ Product - Physical or digital product</option>
                                <option value="subscription" {{ old('order_type') === 'subscription' ? 'selected' : '' }}>🔄 Subscription - Recurring service</option>
                                <option value="domain" {{ old('order_type') === 'domain' ? 'selected' : '' }}>🌐 Domain - Domain registration/transfer</option>
                                <option value="custom" {{ old('order_type') === 'custom' ? 'selected' : '' }}>⚙️ Custom - Custom service</option>
                            </select>
                            @error('order_type')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <select name="billing_cycle" class="select select-bordered focus:select-primary @error('billing_cycle') select-error @enderror">
                                ...
                                <option value="semi_annually" {{ old('billing_cycle') === 'semi_annually' ? 'selected' : '' }}>Semi-Annually (6 months)</option>
                                <option value="annually" {{ old('billing_cycle') === 'annually' ? 'selected' : '' }}>Annually (12 months)</option>
                                <option value="biennially" {{ old('billing_cycle') === 'biennially' ? 'selected' : '' }}>Biennially (24 months)</option>
                                <option value="triennially" {{ old('billing_cycle') === 'triennially' ? 'selected' : '' }}>Triennially (36 months)</option>
                            </select>
                            @error('billing_cycle')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-control">
                            ...
                            <input type="number" name="amount" value="{{ old('amount') }}" step="0.01" min="0" placeholder="0.00" class="input input-bordered focus:input-primary @error('amount') input-error @enderror" required>
                            @error('amount')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                                </label>
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" name="subscription_amount" value="{{ old('subscription_amount') }}" step="0.01" min="0" placeholder="0.00" class="input input-bordered focus:input-primary @error('subscription_amount') input-error @enderror">
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" name="addons_amount" value="{{ old('addons_amount') }}" step="0.01" min="0" placeholder="0.00" class="input input-bordered focus:input-primary @error('addons_amount') input-error @enderror">
                            @error('addons_amount')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                                </label>
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" name="setup_fee" value="{{ old('setup_fee') }}" step="0.01" min="0" placeholder="0.00" class="input input-bordered focus:input-primary @error('setup_fee') input-error @enderror">
                            @error('setup_fee')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                                </label>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-control">
                            ...
                            <input type="text" name="domain_name" value="{{ old('domain_name') }}" placeholder="example.com" class="input input-bordered focus:input-primary @error('domain_name') input-error @enderror">
                            @error('domain_name')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                                </label>
                        ...
                        <div class="form-control">
                            ...
                            <select name="domain_type" class="select select-bordered focus:select-primary @error('domain_type') select-error @enderror">
                                ...
                                <option value="new" {{ old('domain_type') === 'new' ? 'selected' : '' }}>🆕 New Registration</option>
                                <option value="transfer" {{ old('domain_type') === 'transfer' ? 'selected' : '' }}>🔄 Transfer</option>
                                <option value="existing" {{ old('domain_type') === 'existing' ? 'selected' : '' }}>✅ Existing Domain</option>
                            </select>
                            @error('domain_type')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-control">
                            ...
                            <select name="status" class="select select-bordered focus:select-primary @error('status') select-error @enderror" required>
                                <option value="pending" {{ old('status') === 'pending' ? 'selected' : '' }}>⏳ Pending - Waiting for processing</option>
                                <option value="active" {{ old('status') === 'active' ? 'selected' : '' }}>✅ Active - Order is active</option>
                                <option value="suspended" {{ old('status') === 'suspended' ? 'selected' : '' }}>⏸️ Suspended - Temporarily disabled</option>
                                <option value="cancelled" {{ old('status') === 'cancelled' ? 'selected' : '' }}>❌ Cancelled - Order cancelled</option>
                                <option value="completed" {{ old('status') === 'completed' ? 'selected' : '' }}>🏁 Completed - Order completed</option>
                            </select>
                            @error('status')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                        ...
                        <div class="form-control">
                            ...
                            <input type="date" name="next_due_date" value="{{ old('next_due_date') }}" class="input input-bordered focus:input-primary @error('next_due_date') input-error @enderror">
                            @error('next_due_date')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                                </label>
                        ...
                        <div class="form-control md:col-span-2">
                            ...
                            <textarea name="notes" rows="3" placeholder="Additional notes about this order..." class="textarea textarea-bordered focus:textarea-primary @error('notes') textarea-error @enderror">{{ old('notes') }}</textarea>
                            @error('notes')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                                </label>
